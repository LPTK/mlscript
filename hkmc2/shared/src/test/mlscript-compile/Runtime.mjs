...
(class Runtime {
  ...
  static {
    ...
    (class TraceLogger {
      ...
      static log(msg) {
        ...
        scrut = TraceLogger.enabled;
        if (scrut === true) {
          tmp2 = "| ".repeat(TraceLogger.indentLvl);
          tmp3 = "  ".repeat(TraceLogger.indentLvl);
          tmp4 = "\n" + tmp3;
          tmp5 = msg.replaceAll("\n", tmp4);
          tmp6 = tmp2 + tmp5;
          return globalThis.console.log(tmp6)
        }
        return runtime.Unit;
      }
      toString() { return runtime.render(this); }
  ...
  static debugCont(cont) {
    ...
    return globalThis.console.log(tmp3)
  } 
  ...
  static debugContTrace(contTrace) {
    ...
    return globalThis.console.log(contTrace);
  } 
  static debugEff(eff) {
    ...
    return globalThis.console.log(eff);
  } 
  static unwind(...saved) {
    let tmp1;
...
lambda = (undefined, function (self, layout) {
  ...
  tmp2 = layout.str(":");
  tmp3 = layout.str("]");
  return layout.cat(self.underlying, tmp1, self.start, tmp2, self.end, tmp3)
});
cls = LazyArray.internal.getView.class;
f = lambda;
f1 = f;
inlinedVal = RuntimeJS.mk_this_function(f1);
tmp = inlinedVal;
